...
##DATA_PATH = # ตัวอย่าง: หากชุดข้อมูลอยู่ที่ C:\Users\SW02\Downloads\minipro\dataset

DATA_PATH = r"C:\Users\USER01\Desktop\work\LAB07\PetImages"
...
def main():
    ...
    print("--" * 30)
    print("CNN Image Recognition:Duck vs Goose")
    print("--" * 30)
